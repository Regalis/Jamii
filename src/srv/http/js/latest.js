						...
						return function () {
							...
							function () {
								...
								expressInstallCallback: function () {
									if (U) {
										var e = m(N);
										e && S && (e.parentNode.replaceChild(S, e), T && (w(T, !0), J.ie && J.win && (S.style.display = "block")), C && C(x)), U = !1
									}
								}
							}
					}();
		...
		2: [
			function (e, t) {
				function n(e) {
					...
					r.support || this.logger.error("Your browser doesn't seem to support WebRTC"), this.peers = [], u.call(this, this.config), this.on("speaking", function () {
						...
						var i;
						i = t.config.logger === c ? console : t.logger, i.log("event:", e, n, o)
					})
				}
				...
				var i = e("util"),
					...
					c = e("mockconsole"),
					u = e("localmedia");
				i.inherits(n, u), n.prototype.createPeer = function (e) {
					var t;
					...
					if (!r.dataChannel) return this.emit("error", new Error("createDataChannel not supported"));
		...
		12: [
			function (e, t) {
				...
				o.inherits(n, c), n.prototype.start = function (e, t) {
					...
					} else this.localStreams.forEach(function (e) {
						e.stop(), t.emit("localStreamStopped", e)
					}), this.localStreams = []
		...
		18: [
			function (e, t, n) {
				...
				n._setIdCounter = function (e) {
					...
					var h = o.findLine("a=mid:", r);
					h && (c.name = h.substr(6)), o.findLine("a=sendrecv", r, s) ? c.senders = "both" : o.findLine("a=sendonly", r, s) ? c.senders = "initiator" : o.findLine("a=recvonly", r, s) ? c.senders = "responder" : o.findLine("a=inactive", r, s) && (c.senders = "none");
		...
		20: [
			function (e, t) {
				...
				t.exports = function (e, t) {
					...
					r || (r = new i);
					var h, f, d;
					d = r.createAnalyser(), d.fftSize = 512, d.smoothingTimeConstant = a, f = new Float32Array(d.fftSize), e.jquery && (e = e[0]), e instanceof HTMLAudioElement ? (h = r.createMediaElementSource(e), "undefined" == typeof p && (p = !0), u = u || -65) : (h = r.createMediaStreamSource(e), u = u || -45), h.connect(d), p && d.connect(r.destination), s.speaking = !1, s.setThreshold = function (e) {
						u = e
