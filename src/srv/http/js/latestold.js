                ...
                ! function () {
                    if (function (e, t) {
                        ...
                        e.flashsocket = n, t.util.inherit(n, t.Transport.websocket), n.prototype.name = "flashsocket", n.prototype.open = function () {
                            ...
                            var r = this;
                            return document.documentElement ? i() : (t.util.load(i), void 0)
                        }, n.check = function () {
                        ...
                        if ("undefined" != typeof window && !window.WebSocket) {
                            ...
                            "file:" == location.protocol && e.error("WARNING: web-socket-js doesn't work in file:///... URL unless you set Flash Security Settings properly. Open the page via Web server i.e. http://..."), WebSocket = function (e, t, n, o, i) {
                                ...
                                if (!WebSocket.__flash) {
                                    ...
                                    n.id = "webSocketFlash", t.appendChild(n), document.documentElement.appendChild(t), swfobject.embedSWF(WEB_SOCKET_SWF_LOCATION, "webSocketFlash", "1", "1", "10.0.0", null, null, {
                                        hasPriority: !0,
                                        swliveconnect: !0,
                    ...
                    function (e, t, n) {
                        ...
                        e["jsonp-polling"] = o, t.util.inherit(o, t.Transport["xhr-polling"]), o.prototype.name = "jsonp-polling", o.prototype.post = function (e) {
                            ...
                            if (!this.form) {
                                ...
                                a.className = "socketio", a.style.position = "absolute", a.style.top = "0px", a.style.left = "0px", a.style.display = "none", a.target = p, a.method = "POST", a.setAttribute("accept-charset", "utf-8"), c.name = "d", a.appendChild(c), document.documentElement.appendChild(a), this.form = a, this.area = c
                            }
                            ...
                            r.parentNode.insertBefore(n, r), this.script = n, i && setTimeout(function () {
                                ...
                                document.documentElement.appendChild(e), document.documentElement.removeChild(e)
                            }, 100)
